...
<div class="overview-grid">
    ...
    <div class="recent-card">
        ...
        <div style="padding: 2rem;">
            <form action="action.php?act=<?php echo $edit_id > 0 ? 'update_blog_category' : 'save_blog_category'; ?>" method="POST">
                <?php if ($edit_id > 0): ?>
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" id="category_name" name="name" class="form-control" placeholder="e.g. ESSAYS" style="text-transform: uppercase;" value="<?php echo htmlspecialchars($edit_name); ?>" required>
                ...
                <div style="display: flex; gap: 0.6rem;">
                    <?php if ($edit_id > 0): ?>
                        <a href="blog_categories.php" class="btn btn-cancel" style="flex: 1;">Cancel</a>
                    <?php endif; ?>
    ...
    <div class="recent-card">
        <div class="recent-header">
            <h3 class="recent-title"><i class="fa-solid fa-tags"></i> Blog Categories</h3>
        </div>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; padding: 1rem 1.5rem;">
                                    <div style="display: inline-flex; gap: 0.4rem;">
                                        <a href="blog_categories.php?edit=<?php echo $cat['id']; ?>" class="btn-action btn-edit" title="Edit Category">
                                            <i class="fa-solid fa-pencil"></i>
                                        </a>
                                        <a href="action.php?act=delete_blog_category&id=<?php echo $cat['id']; ?>" class="btn-action btn-delete" title="Delete Category" onclick="return confirm('Are you sure you want to delete this category? Any blog posts assigned to this category will not be deleted, but you will need to reassign them to a new category.');">

<?php
$page_title = 'Manage Secretary of Samiti Messages';
require_once __DIR__ . '/includes/sidebar.php';

$doc_type = 'secretary_samiti';
    ...
    <div class="recent-card">
        <div class="recent-header">
            <h3 class="recent-title">
                ...
                <?php echo $edit_id > 0 ? 'Edit Message details' : 'Upload Secretary PDF'; ?>
            </h3>
        </div>
        <div style="padding: 2rem;">
            <form id="document-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group" style="margin-bottom: 1.25rem;">
                    ...
                    <input type="text" id="doc_title" name="title" class="form-control" placeholder="e.g. Secretary Message 2026" value="<?php echo htmlspecialchars($edit_title); ?>" required>
                </div>
                ...
                <div style="display: flex; gap: 0.6rem;">
                    <?php if ($edit_id > 0): ?>
                        <a href="messages_secretary_samiti.php" class="btn btn-cancel" style="flex: 1; text-align: center; text-decoration: none; display: flex; align-items: center; justify-content: center; height: 42px; border-radius: 6px;">Cancel</a>
                    <?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; padding: 1rem 1.5rem;">
                                        <div style="display: inline-flex; gap: 0.4rem;">
                                            <a href="messages_secretary_samiti.php?edit=<?php echo $doc['id']; ?>&page=<?php echo $page; ?>" class="btn-action btn-edit" title="Edit Document"><i class="fa-solid fa-pencil"></i></a>
        ...
        xhr.onload = function() {
            if (xhr.status === 200) {
                try {
                    ...
                    window.location.href = 'messages_secretary_samiti.php?success=' + (isEditMode ? 'updated' : 'created');
                }
            } else {
